...
//        colorLine: ["#000000", "#45c7ba", "#a9533a", "#ff44cc", "#dd1177", "#eeee22", "#ffbb55", "#ff5511", "#777788", "#ff0000", "#ffff00"],
        colorLine: [["#FF0000", "#EF0000", "#DF0000", "#CF0000", "#BF0000", "#AF0000", "#9F0000", "#8F0000", "#7F0000", "#6F0000", "#5F0000"],
            ["#00FF00", "#00EF00", "#00DF00", "#00CF00", "#00BF00", "#00AF00", "#009F00", "#008F00", "#007F00", "#006F00", "#005F00"]],
        colorLineLen: 9,
        colorMove: "#00ff00",
        colorRetract: "#ff0000",
        colorRestart: "#0000ff",
...
//                ctx.moveTo(cmds[i].x*zoomFactor,cmds[i].y*zoomFactor);
                ...
                if(cmds[i].retract==0){
                    if(speedIndex>=0){
                        ctx.strokeStyle = renderOptions["colorLine"][cmds[i].extruder % 2][speedIndex];
